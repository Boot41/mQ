...
import { FaClock, FaUtensils, FaLightbulb, FaSmile, FaHeartbeat } from 'react-icons/fa';
  ...
  return (
    <div className="bg-white py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* Four Key Benefits */}
        <div className="flex justify-between mt-24 pt-12 border-t border-gray-200">
  {[{ title: "Flexible Work Hours" }, { title: "Free Meals" }, { title: "Incubator for New Ideas" }, { title: "Fun With Purpose" }, { title: "Health and Wellness Programs" }].map((benefit, index) => (
    <div
      key={index}
      className="flex items-center p-2 border rounded-lg shadow-sm bg-white h-20 w-4"
    >
