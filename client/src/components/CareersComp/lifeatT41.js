...
const OurAds = () => {
  ...
  return (
    <div className="bg-gray-200 py-8 sm:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <h2 className="text-4xl sm:text-5xl text-gray-800 font-bold mb-4">Life At Think 41</h2>
  ...
  <div className="w-full md:w-1/2 space-y-4 sm:space-y-6">
    <h3 className="text-2xl sm:text-5xl text-gray-800 font-bold mb-2 sm:mb-4">Our Culture and Values</h3>
            ...
            >
              <div className="flex-none w-2 h-8 rounded-full bg-gradient-to-r from-green-400 to-green-600 flex items-center justify-center text-lg font-bold text-white">
                <span className="text-sm">✓</span>
                            ...
                            <div className="ml-2">
                <h3 className="font-semibold text-xl sm:text-sm">{benefit.title}</h3>
              </div>
            </div>
          ))}
        </div>
