        ...
        <div className="flex flex-col lg:flex-row items-center justify-center space-y-8 lg:space-y-0 lg:space-x-16 p-8 bg-white">
          <div className="max-w-lg">
            ...
            <p className="text-lg text-gray-700 mb-4">
              From our hiring decisions to our interactions with each other, our customers, and our partners, we are guided by a clear set of principles integrity, kindness, pragmatism, humility, vision, execution, communication, beauty, and reflection. For our team members, that means we’re committed to building a professional and kind work environment focused on solving the industry’s most significant infrastructure challenges. We focus on integrity and alignment with our principles in everything we do.
            </p>
          ...
          <div className="relative max-w-xl">
            <img src="careers.jpg" alt="office" className="rounded-lg"/>
