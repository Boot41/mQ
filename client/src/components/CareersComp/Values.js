    ...
    <div className="bg-white py-8 sm:py-12">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8"> 
        <div className="flex flex-row items-start justify-between space-x-4 sm:space-x-8 lg:space-x-12">
          {/* Text Section */}
          <div className="w-1/2">
            <h2 className="text-2xl sm:text-5xl lg:text-5xl text-gray-800 font-bold mb-2 sm:mb-4" style={{ fontFamily: 'inherit' }}>
              {valuesData.title}
            </h2>
            <p className="text-sm sm:text-base lg:text-xl text-gray-700 mb-3 sm:mb-6" style={{ fontFamily: 'inherit' }}>
              {valuesData.description}
            </p>
            <h3 className="text-lg sm:text-xl lg:text-5xl font-semibold text-gray-800 mb-2 sm:mb-4" style={{ fontFamily: 'inherit' }}>
