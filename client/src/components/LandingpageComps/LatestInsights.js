  ...
  return (
    <div className="relative px-6 mx-auto max-w-4xl" style={{ fontFamily: 'inherit' }}>
      ...
      <div className="text-center mb-8" style={{ fontFamily: 'inherit' }}>
        <h1 className="text-7xl font-extrabold text-gray-800 mb-4 mt-8" style={{ fontFamily: 'inherit' }}>
          Latest Insight
        </h1>
        <div className="w-32 h-1 bg-orange-400 mx-auto mb-4"></div>
        <p className="text-base text-3xl text-gray-600" style={{ fontFamily: 'inherit' }}>
      ...
      >
        ...
        <div className="p-6" style={{ fontFamily: 'inherit' }}>
          <span className="inline-block bg-blue-100 text-blue-800 text-sm px-2 rounded-full uppercase font-semibold tracking-wide mb-2" style={{ fontFamily: 'inherit' }}>
            AI & Technology
          </span>
          <h2 className="text-3xl font-bold text-gray-900 mb-2" style={{ fontFamily: 'inherit' }}>
            {post.title}
          </h2>
