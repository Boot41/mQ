  ...
  return (
    <>
      <header className="text-center my-5 sm:my-10 p-2 sm:p-4 md:p-10" style={{ fontFamily: 'inherit' }}>
        <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-6xl font-extrabold text-gray-800 mb-2 sm:mb-4" style={{ fontFamily: 'inherit' }}>
          Check Out Some Of Our <span className="text-orange-500">Solutions</span>
        </h1>
      ...
      <Box className="relative mx-auto h-[300px] sm:h-[400px] md:h-[500px] lg:h-[500px] w-full">
        ...
        >
          <Box className="w-full h-full flex items-center justify-center p-2 sm:p-4">
            <Box className="absolute inset-y-1/2 left-2 sm:left-4 transform -translate-y-1/2 flex flex-col bg-opacity-70 p-4 rounded-xl w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] max-w-2xl md:max-w-3xl h-[300px] sm:h-[300px] md:h-[400px] lg:h-[325px] bg-black rounded-lg">
              <Box className="text-left p-2 sm:p-4 h-full rounded-lg flex flex-col justify-between" style={{ fontFamily: 'inherit' }}>
                ...
                <Typography
                  component="div" // Ensure it's div instead of Typography for better flexibility
                  className="text-white mb-3 sm:mb-6 overflow-y-auto"
                  style={{ fontFamily: 'inherit', fontSize: '14px', lineHeight: '1.5', maxHeight: '60%' }} // Adjusted maxHeight
                >
