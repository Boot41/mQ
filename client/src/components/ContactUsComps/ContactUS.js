...
const ContactUsGen = () => {
  return (
    <div className="flex flex-col w-full h-full p-4 lg:p-10 items-center justify-center overflow-y-auto">
      <div className="w-full max-w-lg">
        <form className="flex flex-col gap-4">
          <div className="flex flex-col gap-4">
            ...
            {/* Message Field */}
            <label className="flex flex-col">
              <p className="text-base font-medium pb-2">Message</p>
              <textarea
          ...
          <p className="text-sm text-gray-500 pb-3 pt-1 text-center">
            By clicking 'Submit Inquiry', I agree to the use of my details to
          ...
          <div className="flex">
            <button
              type="submit"
              className="w-full h-12 px-5 rounded-full bg-orange-500 text-white text-base font-bold hover:bg-blue-700 transition-all duration-200 ease-in-out"
            >
              Submit Inquiry
            </button>
          </div>
