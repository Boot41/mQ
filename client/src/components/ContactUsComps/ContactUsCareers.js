      ...
      <div className="w-full max-w-lg">
        <form className="flex flex-col gap-4">
          <div className="flex flex-col gap-4">
            ...
            {/* Country Field */}
            <label className="flex flex-col">
              <p className="text-base font-medium pb-2">Country</p>
              <input
            ...
            {/* Resume Upload Field */}
            <label className="flex flex-col">
              <p className="text-base font-medium pb-2">Upload Your Resume</p>
              <input
                type="file"
                className="form-input w-full resize-none rounded-xl border border-gray-300 bg-white h-14 p-3 text-base"
              />
            </label>
          </div>
          ...
          <p className="text-sm text-gray-500 pb-3 pt-1 text-center">
            By clicking 'Apply Now', I agree to use of my details to contact me
...
export default ContactUsCareers;
