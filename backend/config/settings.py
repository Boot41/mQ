...
SECRET_KEY = "django-insecure-vlb#$_g*rq1@i2ji+ii7flw*pr#2pl&f=x6&7y%c8a+g6z**_j"
...
MIDDLEWARE = [
    ...
    # 'django.middleware.csrf.CsrfViewMiddleware',  # Comment this line out
...
# Serving staticfiles files in development
