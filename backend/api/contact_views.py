...
def handle_service_contact(request):
    if request.method == "POST":
        ...
        organization = request.POST.get('organization')  # Added organization extraction
        ...
        print(f"Email: {email}")
        print(f"Phone: {phone}")
        print(f"Organization: {organization}")  # Added organization print
        ...
        # Create and save the ServiceContact instance
        try:
            service_contact = ServiceContact(
                name=name,
                email=email,
                phone=phone,
                organization=organization,  # Added organization to the instance
                message=message,
